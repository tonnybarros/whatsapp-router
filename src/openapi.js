      ...
      schemas: {
        ...
        Connector: {
          ...
          properties: {
            id: { type: "string" },
            name: { type: "string" },
            provider: { type: "string", enum: ["uazapi", "waha", "evolution_go", "evolution_api", "custom"] },
            base_url: { type: "string" },
            auth_header: { type: "string", nullable: true, description: "Nome do header que receberá Token/API Key. No custom, use Authorization quando precisar Bearer." },
            send_path: { type: "string", nullable: true },
            health_path: { type: "string", nullable: true },
            custom_headers: { type: "string", nullable: true, description: "JSON de headers extras para provider custom." },
            custom_body_template: { type: "string", nullable: true, description: "JSON template do corpo para provider custom. Aceita {{to}}, {{number}}, {{message}}, {{source}}, {{track_id}}, {{external_id}}, {{session}} e {{instance}}." },
            status: { type: "string" },
            health: { type: "string" },
